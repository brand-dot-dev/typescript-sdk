...
import retrieve_by_isin_brand from './brand/retrieve-by-isin-brand';
import retrieve_by_name_brand from './brand/retrieve-by-name-brand';
...
addEndpoint(retrieve_by_isin_brand);
addEndpoint(retrieve_by_name_brand);
