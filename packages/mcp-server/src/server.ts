...
export { ClientOptions } from 'brand.dev';
...
export function initMcpServer(params: {
  ...
  const client = new BrandDev(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client || new BrandDev({ defaultHeaders: { 'X-Stainless-MCP': 'true' }, logger: logger });
