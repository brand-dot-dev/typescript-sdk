...
[![NPM version](https://img.shields.io/npm/v/brand.dev.svg)](https://npmjs.org/package/brand.dev) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/brand.dev)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/brand.dev-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npm install brand.dev`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/brand.dev-typescript/issues) with questions, bugs, or suggestions.
